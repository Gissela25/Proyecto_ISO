    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3 my-3">
            <?php
                    ...
                    foreach ($this->modelo->showzaall() as $r)
                     {
                        $path="img/".$r->Imagen;
                        if(file_exists($path))
                        {
            ...
            <div class="col" id="id_<?=$r->ID_Producto?>">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Precio <?=$r->Precio_ZA?> $</p>
                        <?php
                                    if(($r->Cantidad_ZA)>0)
                                    {
                                        ?>
                        ...
                        <?php
                                    ...
                                    ?>
                        <a href="?c=products&a=Detailszac&id=<?=$r->ID_Producto?>" class="btn btn-primary btn-block boton">Ver
                            más</a>
                    </div>
                </div>
            </div>
