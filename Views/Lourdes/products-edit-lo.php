...
<body>
    <div class="d-flex justify-content-center">
        <div class="col-md-4 my-5">
            ...
            <form class="formulario" method="POST" action="<?=PATH?>?c=products&a=Savelop">
                ...
                <div class="mb-3" style="color:#084594">
                    ...
                    <input type="numbers" class="form-control" name="Precio_LO" value="<?=$p->getPro_prelo()?>" pattern="^[0-9]+([.][0-9]+)?$" required>
                </div>
                <div class="mb-3" style="color:#084594">
                    <label for="exampleInputPassword1" class="form-label">Existencias Lourdes</label>
                    <input type="numbers" class="form-control" name="Cantidad_LO" value="<?=$p->getPro_canlo()?>" pattern="^[0-9]+$" required>
                </div>
                <div class="d-flex justify-content-center">
                    <div class="my-2">
