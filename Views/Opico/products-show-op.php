...
<body>
    <?php require_once "Views/Constant/empleados/OP/nav.php"?>
                ...
                <table class="table table-bordered">
                   ...
                   ?>
                        <tr < id="id_<?=$r->ID_Producto?>">
                            ...
                            <td><?=$r->Cantidad_OP?></td>
                            <td>
                                <a class="edit mx-3" href="<?=PATH?>?c=products&a=editop&id=<?=$r->ID_Producto?>"><i class="bi bi-pencil-square"></i> Editar
