...
<head>
    ...
    <link rel="stylesheet" href="<?=PATH?>Assets/css/family-insert.css">
...
<body>
    <div class="d-flex justify-content-center">
        ...
        <img src="<?=PATH?>Assets/img/logo.PNG" class="rounded mx-auto d-block mb-3" alt="..." height="85px"
                    width="230px">       
        <form class="formulario" method="POST" action="<?=PATH?>?c=family&a=Save">
                ...
                <div class="mb-3" style="color:#084594">
                    ...
                    <input type="name" class="form-control" name="Nombre" value="" pattern="^[a-zA-Z\s]{2,254}" required>
                </div>
                <div class="d-flex justify-content-center">
                    <div class="my-2">
