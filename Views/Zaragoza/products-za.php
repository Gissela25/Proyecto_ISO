...
<body>
<?php require_once "Views/Constant/empleados/ZA/nav.php";?>
        ...
        <div class="col ml-5">
            ...
            <div class="row mt-3">
                <table class="table table-bordered">
                   ...
                   foreach ($this->modelo->Showzaw() as $r)
                   {
                      $path="img/".$r->Imagen;
                      if(file_exists($path))
                        ...
                        <tr < id="id_<?=$r->ID_Producto?>">
                            ...
                            <td>
                                ...
                                <a class="edit mx-3" href=""><i class="bi bi-trash-fill"></i> Eliminar
                                    <i class="fa fa-lg fa-refresh"></i></a> -->
                                <a class="edit mx-3" href="<?=PATH?>?c=products&a=Insertza&id=<?=$r->ID_Producto?>"><i
